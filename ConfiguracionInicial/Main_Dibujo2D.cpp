...
int main() {
	...
	float vertices[] = {
		...
		// FONDO	
		-1.0f, 1.0f, 0.0f,    0.5f,0.5f,0.5f, //0
		-1.0f, 0.5f, 0.0f,    0.5f,0.5f,0.5f, //1
		-0.5f, 1.0f, 0.0f,    0.5f,0.5f,0.5f, //2

		-1.0f, 0.5f, 0.0f,    1.0f,1.0f,1.0f,
		-0.5f, 1.0f, 0.0f,    1.0f,1.0f,1.0f,
		0.0f, 0.5f, 0.0f,     1.0f,1.0f,1.0f, //3

		-1.0f, 0.5f, 0.0f,    0.5f,0.5f,0.5f,
		0.0f, 0.5f, 0.0f,     0.5f,0.5f,0.5f,
		-0.0f, 0.25f, 0.0f,   0.5f,0.5f,0.5f, //4
	};
